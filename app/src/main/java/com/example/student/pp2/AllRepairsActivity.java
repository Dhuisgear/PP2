...
public class AllRepairsActivity extends ListActivity {
    ...
    private static String url_all_repairs = Constants.URL_GET_ALL_REPAIRS;
     ...
     */
    class LoadAllRepairs extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AllRepairsActivity.this);
...
//            progressDialog.show();
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_repairs, "GET", params);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllRepairsActivity.this, repairsList,
